      ...
      <div className="background-image row">
        ...
        <div className='col-5 text-white align-self-center'>
          <div className='mt-5'>
            ...
            <h3>Our number one mission is to deliver the best possible</h3>
            <h3>pizza for the best possible price for our customers. </h3>
          </div>
        </div>   
      </div>

      <div className='mt-5 mb-5 row container-fluid'>
      ...
      <div className='mb-5'>
        ...
        <div className=''>
          ...
          <div className='row d-flex justify-content-center'>
            ...
            <div className='col-4 images-pizzas-container'>
              <img className='rounded-4 ' width="400" height="400" src={pepperoni} alt="description of image"/>
              <div class="overlay">
                <div class="text-overlay">
            ...
            <div className='col-4 images-pizzas-container'>
              <img className='rounded-4' width="400" height="400" src={chesses4} alt="description of image"/>
              <div class="overlay">
                <div class="text-overlay">
